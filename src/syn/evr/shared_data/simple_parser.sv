...
localparam logic [7:0] MRF_TRANSFER_STOP  = 8'h3C;
    ...
    assign chsum_ena = (parser_state != RECV_HEADER0)   && (parser_state != RECV_HEADER1) &&
                       (parser_state != RECV_END)       && (parser_state != RECV_CHSUM_MSB) && 
                       (parser_state != RECV_CHSUM_LSB) && (parser_state != RESET);
