...
localparam COUNT_TO = 100;
    ...
    always @(posedge clk) begin
        if(!aresetn) begin
            ...
            if(S00_AXI_arvalid || S00_AXI_awvalid || S00_AXI_wvalid) begin
